...
_C.MODEL.INSTRUCTION_ENCODER.embedding_file = (
    "data/datasets/R2R_VLNCE_NRSub/embeddings200d.json.gz"
)
_C.MODEL.INSTRUCTION_ENCODER.dataset_vocab = (
    "data/datasets/R2R_VLNCE_NRSub/train/train.json.gz"
)
...
_C.MODEL.DEPTH_ENCODER.output_size = 3072
_C.MODEL.DEPTH_ENCODER.feature_size = 256
_C.MODEL.DEPTH_ENCODER.single_size = 192
